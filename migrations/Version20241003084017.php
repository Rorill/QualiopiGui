 ...
 */
final class Version20241003084017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formations DROP site');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formations ADD site VARCHAR(255) NOT NULL');
    }
}
